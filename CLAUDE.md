...
> Genel kurallar: `~/Projects/claude-config/CLAUDE.md`
...
3. **Her oyun ayrı Jira + CLAUDE.md** — ClaudeHQ `projects.json`'a sub-project olarak kayıt
4. **Claude agent katmanı** — `puzzle-designer`, `balance-tuner`, `juice-polish`, `playtest-bot`
...
1. `~/Projects/claude-config/CLAUDE.md` oku
